...
export const Cta4 = ({
  ...
  return <section className="py-16 px-4"><div className="container mx-auto"><div className="flex justify-center"><div className="w-full max-w-5xl"><motion.div
    ...
    style={{
      background: "linear-gradient(135deg, #fff7ed 0%, #fffbeb 55%, #fefce8 100%)",
  ...
  ><span className="flex h-5 w-5 flex-shrink-0 items-center justify-center rounded-full bg-orange-100 border border-orange-200"><Check className="size-3 text-orange-500" /></span>{item}</motion.li>)}</ul></div></motion.div></div></div></div></section>;
};
