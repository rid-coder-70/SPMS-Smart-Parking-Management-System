      ...
      <div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {managementCards.map(item => (
            ...
            >
              <div className="w-11 h-11 rounded-xl bg-orange-50/70 border border-orange-100 flex items-center justify-center flex-shrink-0 group-hover:scale-105 transition-transform">
                {item.icon}
              </div>
